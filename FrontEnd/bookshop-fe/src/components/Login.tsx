    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-lg flex w-[500px] overflow-hidden">
        <form className="flex-1 p-8" onSubmit={handleSubmit}>
          <h2 className="text-xl font-bold mb-6">Đăng nhập bằng email</h2>
          <div className="mb-4">
            <input
              type="email"
          ...
          <button type="submit" className="w-full bg-red-500 text-white font-bold py-2 rounded mt-2">Đăng nhập</button>
          <div className="flex justify-between mt-4 text-sm">
            <a href="#" className="text-blue-500">Quên mật khẩu?</a>
            <a href="#" className="text-blue-500">Tạo tài khoản</a>
          </div>
        </form>
